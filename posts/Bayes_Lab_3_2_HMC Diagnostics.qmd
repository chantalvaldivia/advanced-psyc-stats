...
Draws are a little bit like the first pancake, you're not quite where you need to be with your early samples and if you include them your could skew the accuracy of your posterior check
...
An undesirable autocorrelation would probably either be complete overlap of lines (so a \_\_\_\_\_ instead of an L) or a longer L shape (think an obstuse angle) meaning you're taking a really long time to reach low autocorrelation.

L-shaped autocorrelation plots are desirable because they indicate we're taking an appropriate amount of time and exploring parameter space efficiently (I had to consult google for help on this question)
